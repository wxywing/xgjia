...
<head>
    ...
    <meta name="description" content="信鸽之家密码重置页面，设置新密码以恢复账号访问。">
    <meta name="keywords" content="重置密码,信鸽之家">
    <meta name="robots" content="noindex, nofollow">
    <meta property="og:title" content="重置密码 - 信鸽之家">
    <meta property="og:description" content="信鸽之家密码重置页面，设置新密码以恢复账号访问。">
    ...
    <link rel="canonical" href="https://www.xgjia.com/reset-password">

    <title>重置密码 | <?php echo SITE_NAME; ?></title>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="password" id="password" name="password" class="form-control" 
                           ...
                           minlength="6"
                           required autofocus>
                    <div class="password-hint">密码至少需要6位字符</div>
                </div>
