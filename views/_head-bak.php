...
<nav class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav-links">
            ...
            <li><a href="/pigeon/" <?php echo strpos($_SERVER['REQUEST_URI'], '/pigeon') !== false ? 'class="active"' : ''; ?>>铭鸽</a></li>
            <li><a href="/shop/" <?php echo strpos($_SERVER['REQUEST_URI'], '/shop') !== false ? 'class="active"' : ''; ?>>展厅</a></li>
            <li><a href="/loft/" <?php echo strpos($_SERVER['REQUEST_URI'], '/loft') !== false ? 'class="active"' : ''; ?>>公棚</a></li>
            <li class="nav-dropdown">
                <a href="/pedigree/" class="nav-dropdown-toggle" <?php echo strpos($_SERVER['REQUEST_URI'], '/pedigree') !== false ? 'style="color:var(--primary);border-bottom:2px solid var(--primary);"' : ''; ?>>血统 <i class="fas fa-angle-down"></i></a>
            ...
            <li><a href="/article/" <?php echo strpos($_SERVER['REQUEST_URI'], '/article') !== false ? 'class="active"' : ''; ?>>资讯</a></li>
            <li><a href="/dynamic/" <?php echo strpos($_SERVER['REQUEST_URI'], '/dynamic') !== false ? 'class="active"' : ''; ?>>鸽友圈</a></li>
        </ul>
        <div class="nav-actions">
            <form action="/search/" method="GET" class="nav-search">
                <input type="text" name="q" placeholder="搜索铭鸽、公棚、资讯..." value="<?php echo h($_GET['q'] ?? ''); ?>">
...
<div class="mobile-nav" id="mobileNav">
    <div class="mobile-nav-panel">
        ...
        <div class="mobile-nav-links">
            ...
            <a href="/pigeon/" <?php echo strpos($_SERVER['REQUEST_URI'], '/pigeon') !== false ? 'class="active"' : ''; ?>>铭鸽</a>
            <a href="/shop/" <?php echo strpos($_SERVER['REQUEST_URI'], '/shop') !== false ? 'class="active"' : ''; ?>>展厅</a>
            <a href="/loft/" <?php echo strpos($_SERVER['REQUEST_URI'], '/loft') !== false ? 'class="active"' : ''; ?>>公棚</a>
            ...
            <a href="/article/" <?php echo strpos($_SERVER['REQUEST_URI'], '/article') !== false ? 'class="active"' : ''; ?>>资讯</a>
            <a href="/dynamic/" <?php echo strpos($_SERVER['REQUEST_URI'], '/dynamic') !== false ? 'class="active"' : ''; ?>>鸽友圈</a>
        </div>
